...
@section('content')
    ...
    <div class="container w-full md:w-4/5 xl:w-3/5 mx-auto px-2">
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <a href="/user/create" class="px-3 py-0 rounded-md bg-green-500 text-white">СОЗДАТЬ</a>
                ...
                @foreach($users as $user)
                    <tr class="border-t">
                        ...
                        <td class="px-3 py-1 border-r">
                            <a href="/user/rud/{{$user->id}}?method=edit" class="px-2 py-0 text-xs rounded-md bg-green-500 text-white">edit</a>
                            <a href="/user/rud/{{$user->id}}?method=pass" class="px-2 py-0 text-xs rounded-md bg-blue-500 text-white">pass</a>
                            <a href="/user/rud/{{$user->id}}?method=delete" class="px-2 py-0 text-xs rounded-md bg-red-400">del</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>

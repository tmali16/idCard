                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                ...
                                @foreach($items as $item)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white flex flex-col">
                                            <div>{{$item->sector_name ?? $item->lac . "_" . $item->cid}}</div>
                                            <div class="text-xs text-gray-700">{{$item->address}}</div>
                                        </td>
                                        <td class="px-6 py-4">
